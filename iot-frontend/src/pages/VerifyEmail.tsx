...
function VerifyEmail() {
  const { mutate, isSuccess, isError, error, isLoading } = useVerifyEmail();
        ...
        <CardContent>
          ...
          {!isSuccess && !isError && (
            <Box>
              ...
              >
                Please wait we are verifying your email address. After your
                email address is verified you will be redirected to set up your
                account password.
              </Typography>
            </Box>
          )}
